# base/common.py
from .utils_model import *  # 假设你有一个 utils_model.py 文件在 base 文件夹下
import torch
import torch.nn as nn
import torch.nn.functional as F
from typing import Union, Tuple, List, Any
#from .utils_model import setup_kwargs, filter_kwargs # 假设你的 utils_model.py 包含这些函数
#from .config_vae import ConfigVAE # 如果你需要 ConfigVAE，取消注释
#from torch import distributions as dists # 如果你需要 dists，取消注释
MULT = 2
